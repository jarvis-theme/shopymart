						...
						<table class="shopping-cart">
							...
							<tr>
								...
								<td class="remove-update">
									<a href="{{URL::to('konfirmasiorder/'.$item->id)}}" class="tip update" title="Konfirmasi Pembayaran"><img src="{{URL::to(dirTemaToko().'shopymart/assets/images/update.png')}}" alt=""></a>
								</td>
							</tr>
							@endforeach
						</table>
					...
					{{Form::open(array('url'=>'member/update','method'=>'put','class'=>'form-register'))}}
						...
						<div class="registerbox">
							<fieldset>
								...
								<div class="control-group">
									<label class="control-label">
										<span class="red">*</span>Telepon / HP:
									</label>
									<div class="controls">
