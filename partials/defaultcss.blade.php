<!-- Default css-->
@if($tema->isiCss=='')
	{{generate_theme_css('shopymart/assets/css/style.css?v=001')}} 
@else
...
<link href='//fonts.googleapis.com/css?family=Open+Sans:400,300,600,700|Arvo:400,400italic,700,700italic' rel='stylesheet' type='text/css'>